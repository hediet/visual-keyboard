...
export const bindings = [
	...
	},
	{
		...
		when:
			"editorLangId == 'search-result' && editorLangId == 'search-result'",
	},
	{
		key: "ctrl+down",
	...
	},
	{
		...
		when:
			"config.latex-workshop.bind.altKeymap.enabled && editorLangId == 'latex'",
	},
	{
		key: "ctrl+alt+f",
	...
	{ key: "ctrl+r l", command: "npm-script.showOutput" },
	{
		...
		when:
			"editorTextFocus && !editorReadonly && editorLangId == 'objectpascal'",
	},
	...
	},
	{
		...
		when:
			"editorTextFocus && !editorReadonly && editorLangId =~ /latex|rsweave/",
	},
	{
		key: "alt+s",
...
// - commentAnchors.listTags
// - commentAnchors.openFileAndRevealLine
// - commentAnchors.parse
// - commentAnchors.toggle
// - compareFiles
// - compareSelected
// - compositionEnd
// - compositionStart
...
// - easy-attach-vscode.attach-to-extension-host
// - easy-attach-vscode.insert-code
// - edit-csv.apply
...
// - explorer.newFolder
// - extension.checkDup
// - extension.checkDupForAllFiles
// - extension.checkDupWithRegex
// - extension.checkDupWithTrim
// - extension.chrome-debug.toggleSkippingFile
// - extension.chrome-debug.toggleSmartStep
// - extension.codeSelectUntil
// - extension.disablePrettySymbols
// - extension.enablePrettySymbols
// - extension.escapeJsonString
...
// - extension.togglePrettySymbols
// - extension.unescapeJsonString
...
// - map-replacejs.mapSelectionWithJsFunc
...
// - maven.artifactSearch
// - maven.completion.selected
...
// - prettier.openOutput
// - prettifySymbolsMode.copyWithSubstitutions
// - prettifySymbolsMode.disablePrettySymbols
// - prettifySymbolsMode.enablePrettySymbols
// - prettifySymbolsMode.togglePrettySymbols
...
// - repl.action.copyAll
// - replacePreviousChar
// - resolve-option-authStatusBar
// - resolve-option-nodeDebugStatusBar
// - revealInExplorer
// - review.openFile
// - review.suggestDiff
// - rls.restart
...
// - update.updating
// - versionlens.hideDependencyStatuses
// - versionlens.hideTaggedVersions
// - versionlens.hideVersionLenses
// - versionlens.linkCommand
// - versionlens.showDependencyStatuses
// - versionlens.showTaggedVersions
// - versionlens.showVersionLenses
// - versionlens.showingProgress
...
// - workbench.view.extension.comment-anchors
